...
实时感受海伯利安网络的脉动。我们的全球监控大屏能够实时追踪在线节点、GPU 遥测数据以及全球任务分布情况。

**[访问全球实时监控大屏 →](https://aoezhb.github.io/hyperion_engine/dashboard.html)**
...
**演示模式 (模拟环境)**
使用 `--demo` 参数运行，可模拟任务分配、计算过程及奖励收益，无需连接真实网络。用于产品演示。
```bash
cargo run -- --demo
```
